...
{
    internal class Movies1k
    {
        public static void MoviesLinear1k()
        {
            Console.WriteLine("Enter movie that you would like to find:");
            string input = Console.ReadLine();
            string FilePath = Path.Combine(Environment.CurrentDirectory, "movieTitles1K.txt");
        ...
        public static void MoviesBinary1k()
        {
            Console.WriteLine("Enter movie that you would like to find:");
            string input = Console.ReadLine();
            string FilePath = Path.Combine(Environment.CurrentDirectory, "movieTitles1K.txt");
