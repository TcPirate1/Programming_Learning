...
{
    internal class Movies10k
    {
        public static void MoviesLinear10k()
        {
            Console.WriteLine("Enter movie that you would like to find:");
            string input = Console.ReadLine();
            string FilePath = Path.Combine(Environment.CurrentDirectory, "movieTitles10K.txt");
        ...
        public static void MoviesBinary10k()
        {
            Console.WriteLine("Enter movie that you would like to find:");
            string input = Console.ReadLine();
            string FilePath = Path.Combine(Environment.CurrentDirectory, "movieTitles10K.txt");
