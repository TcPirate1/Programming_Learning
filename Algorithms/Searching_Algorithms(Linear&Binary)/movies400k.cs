...
{
    internal class Movies400k
    {
        public static void MoviesLinear400k()
        {
            Console.WriteLine("Enter movie that you would like to find:");
            string input = Console.ReadLine();
            string FilePath = Path.Combine(Environment.CurrentDirectory, "movieTitles400K.txt");
        ...
        public static void MoviesBinary400k()
        {
            Console.WriteLine("Enter movie that you would like to find:");
            string input = Console.ReadLine();
            string FilePath = Path.Combine(Environment.CurrentDirectory, "movieTitles400K.txt");
